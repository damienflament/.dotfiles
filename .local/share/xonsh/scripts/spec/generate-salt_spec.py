...
def describe_command_generate_salt():
    ...
    def it_shows_help_screen(command):
        ...
        (
            assert_that(command("generate-salt --help"))
            .succeeds()
            .and_stdout()
    ...
    def it_generate_string_of_specified_length(command, length: int):
        ...
        (
            assert_that(command("generate-salt", "--length", length))
            .succeeds()
            .and_stdout()
            .is_length(length)
        )
